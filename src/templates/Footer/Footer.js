...
export default class Footer extends Component {
  render() {
    return (
      <footer className="px-4 divide-y bg-black dark:text-coolGray-100">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center w-60 h-12 rounded-full dark:bg-violet-400">
                <img
          ...
          <div className="grid grid-cols-2 text-sm gap-x-5 gap-y-8 lg:w-3/2 sm:grid-cols-4">
            <div className="space-y-3">
              <ul className="space-y-1 ">
                <div className="py-6 text-white md:py-0 md:px-6">
                  <div className="space-y-4">
                    ...
                    <p className="flex items-center">
                      ...
                      <span>Cơ sở 2: 459 Sư Văn Hanh,Quận 10</span>
                    </p>
                    <p className="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="space-y-3">
              <h3 class="text-white uppercase dark:text-coolGray-50">
                Đăng kí để tư vấn
              </h3>
              <form
                noValidate
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-pink-50 w-full p-3 text-sm font-bold tracking-wide uppercase rounded dark:bg-violet-400 dark:text-coolGray-900 hover:bg-yellow-200"
                >
                  Đăng Kí Tư Vấn
                </button>
              </form>
        ...
        <section className="dark:bg-coolGray-800 dark:text-coolGray-100">
          <div className="text-white container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
            <div className="py-6 text-sm text-center text-white">
              © 2022 Company CyberLearn All rights reserved.
            </div>
            <div className="flex flex-wrap justify-center lg:justify-between">
              <svg
                ...
                viewBox="0 0 32 32"
                aria-label="Angular"
                className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-coolGray-400"
              >
                <title>Angular</title>
